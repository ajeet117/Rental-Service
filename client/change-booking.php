...
if(isset($_POST['submit']))
{
  ...
  {
  $update_query="UPDATE tb_bookings SET from_date='$from_date' , from_time='$from_time' , to_date='$to_date' ,to_time='$to_time' WHERE booking_id='$booking_id'";
  ...
  if(!$update_result)
  {
    ...
    echo "<p> succesfully changed <a href='my-booking.php' style='text-decoration:underline'>click here to see</a> </p>";
  }
  }
  else
{
